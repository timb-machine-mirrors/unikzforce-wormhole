...
func file_cmd_test_agent_test_agent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cmd_test_agent_test_agent_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_cmd_test_agent_test_agent_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_cmd_test_agent_test_agent_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_cmd_test_agent_test_agent_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_cmd_test_agent_test_agent_proto_msgTypes[4].Exporter = func(v any, i int) any {
